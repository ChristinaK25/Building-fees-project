...
public class PrintPreviewDialog extends javax.swing.JDialog {
    ...
    public PrintPreviewDialog(String text) {
        initComponents();
        // Start html code with <html> and end with </html>
        String newText = "<html>" + text + "</html>";
        _text = newText;
        this.mainEditorPane.setText(newText);
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrintPreviewDialog().setVisible(true);
            }
        });
    }
